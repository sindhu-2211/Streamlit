...
polyuria = st.text_input("Polyuria (Enter 1 for Yes, 0 for No):")
polydipsia = st.text_input("Polydipsia (Enter 1 for Yes, 0 for No):")
...
polyphagia = st.text_input("Polyphagia (Enter 1 for Yes, 0 for No):")
genital_thrush = st.text_input("Genital Thrush (Enter 1 for Yes, 0 for No):")
...
alopecia = st.text_input("Alopecia (Enter 1 for Yes, 0 for No):")
